...
do i = 0,Nprocs_for_seq-1
    ...
    CALL RungeKutta_Method_Phi_For_time_sequential_cal(phi(iconductor),tstart_myslice, tend_myslice, N_coarse,C_inv,iconductor,rho1, rho2, Temp1, Temp2, i, Nprocs_for_seq, outputfilename) 
end do
